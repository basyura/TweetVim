...
call s:set_global_variable('tweetvim_datetime_format'        , '%m/%d %H:%M')
call s:set_global_variable('tweetvim_padding_left'           , '                  ')
call s:set_global_variable('tweetvim_format_left'            , '{icon}{username}{favorited}{text}{rt}')
call s:set_global_variable('tweetvim_format_right'           , '{from}{time}')
call s:set_global_variable('tweetvim_favorited_sign'         , '★ ')
call s:set_global_variable('tweetvim_unfavorited_sign'       , '')
